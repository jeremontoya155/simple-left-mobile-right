...
const IntegrationSection = () => (
  <section className="py-16 px-4 bg-white">
    <div className="container mx-auto text-center">
      <h2 className="text-3xl md:text-4xl font-bold mb-6">Integraciones</h2>
      ...
      <div className="flex justify-center flex-wrap gap-8 mb-12">
        {integrations.map((el) => (
          <div key={el.name} className="flex flex-col items-center gap-2 transform transition-all duration-300 hover:scale-110">
            <div className="bg-gray-100 p-6 rounded-full shadow-md hover:shadow-lg">
              {el.icon}
            </div>
